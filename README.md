...
points they scored.
    ...
    a <- ggplot(spurs_2013_regular, aes(x=spurs_score, fill = W_L)) + 
...
W/L record.
    ...
    b <- ggplot(timmy_2013_team, aes(x = W_L, y = pts)) +
...
W/L record.
    ...
    c <- ggplot(timmy_2013_team, aes(x = pts, y = reb))+ 
...
game.
    ...
    d <- ggplot(timmy_2013_team, aes(x = pts, y = reb)) + 
